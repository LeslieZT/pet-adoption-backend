...
authenticationContainer
	.bind<AuthenticationController>(AUTHENTICATION_TYPES.AuthenticationController)
	.to(AuthenticationController);
authenticationContainer
	.bind<AuthenticationService>(AUTHENTICATION_TYPES.AuthenticationService)
	.to(AuthenticationService);
authenticationContainer
	.bind<UserRepository>(AUTHENTICATION_TYPES.UserRepository)
	.to(UserRepositoryImpl);
authenticationContainer
	.bind<AuthenticationProvider>(AUTHENTICATION_TYPES.AuthenticationProvider)
	.to(SupabaseAuthenticationProviderImpl);
authenticationContainer
	.bind<BcryptManager>(AUTHENTICATION_TYPES.BcryptManager)
	.to(BcryptManagerImpl);
authenticationContainer
	.bind<AuthenticationMiddleware>(AUTHENTICATION_TYPES.AuthenticationMiddleware)
